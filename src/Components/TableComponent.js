...
function TableComponent() {
    ...
    return (
        <>
            ...
            <PDFDownloadLink variant="success" className='m-2 btn custom-btn' document={<DownloadComponent workouts={workouts}/>} fileName='workout' >Download PDF</PDFDownloadLink>
        </>
    )
}
